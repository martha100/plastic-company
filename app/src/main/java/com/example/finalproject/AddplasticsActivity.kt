...
class AddplasticsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_addplastics)
    ...
    private fun uploadImage(){
        ...
        if (model.isEmpty()){
            ...
            if(filePath != null){
                ...
                val ref = storageReference?.child("Plastics/" + UUID.randomUUID().toString())
                progress.show()
                val uploadTask = ref?.putFile(filePath!!)!!.addOnCompleteListener{
                    ...
                    if (it.isSuccessful){
                        ref.downloadUrl.addOnSuccessListener {
                            ...
                            var ref = FirebaseDatabase.getInstance().getReference().child("Plastics/$id")
                            ref.setValue(carData)
                            Toast.makeText(this, "plastic submitted successfully", Toast.LENGTH_SHORT).show()
                        }
                    }else{
                        Toast.makeText(this, "plastic submission failed", Toast.LENGTH_SHORT).show()
                    }
                }
